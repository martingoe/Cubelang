package com.cubearrow.cubelang.frontend.parser
...
class Parser(private var tokens: List<Token>, private var errorManager: ErrorManager) {
    ...
    private fun forStatement(): Statement {
        ...
        val init = when {
            match(TokenType.SEMICOLON) -> Statement.Empty()
        ...
        val incrementor = if (peek(TokenType.BRCKTR)) Statement.Empty() else Statement.ExpressionStatement(expression())
