 ...
 */
enum class Token {
    IDENTIFIER, IF, RETURN, FUN, WHILE, BRCKTL, BRCKTR, SEMICOLON, ADD, SUB, EXP, DIV, MULT, MOD, EQEQ, EXCLEQ, AND_GATE, OR_GATE, INT_LITERAL, DOUBLE_LITERAL, CHAR_LITERAL, INT_TYPE, DOUBLE_TYPE, INT, EQUALS, NOT_FOUND;
    ...
    companion object {
         ...
         */
        fun fromString(string: String, tokenGrammar: TokenGrammar): Token {
