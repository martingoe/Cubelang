...
enum class TokenType {
    IDENTIFIER, CURLYR, CURLYL, LINE_COMMENT, IF, ELSE, RETURN, FUN, WHILE, BRCKTL, BRCKTR, SEMICOLON, OPERATOR, COMPARATOR, AND_GATE, OR_GATE, NUMBER, EQUALS, NOT_FOUND, COMMA, STRING, FOR, VAR, CLASS, DOT, COLON, NULLVALUE;
    ...
    companion object {
         ...
         * @param tokenGrammar The lexer grammar in [TokenGrammar]. This contains the regexes that the string has to match.
