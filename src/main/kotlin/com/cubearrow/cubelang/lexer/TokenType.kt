...
enum class TokenType {
    IDENTIFIER, CURLYR, CURLYL, LINE_COMMENT, IF, ELSE, RETURN, FUN, WHILE, BRCKTL, BRCKTR, SEMICOLON, OPERATOR, COMPARATOR, AND_GATE, OR_GATE, NUMBER, EQUALS, NOT_FOUND, COMMA, STRING, FOR, VAR;
